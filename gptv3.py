...
max_iterations = 15000  # Change for GPU. (v1 1000 test, 3000 train) - (v2 200 test, x train)
learning_rate = 3e-4  # 3e-3 = 0.003 - 3e-4, 1e-3, 1e-4
eval_iterations = 3000  # Change for purpose. (v1 250 test, 500 train) - (v2 100 test, x train)
# Affect memory.
